...
|---|---|---|
| Latest local full command | T54 external `make ci BASE_REF=origin/master`: Go vet/tests/race, 47 frontend tests/build, hooks, architecture and spec drift | PASS; PostgreSQL test skipped without local database URL |
...
| All product PRE_MERGE behavior | VERIFYING | T1-T15, T20-T38, T40-T52, and T54 pass; T53 awaits PostgreSQL execution |
