...
|---|---|---|
| Latest local full command | T52 external `make ci BASE_REF=origin/master`: Go vet/tests/race, 46 frontend tests/build, hooks, architecture and spec drift | PASS |
...
| All product PRE_MERGE behavior | PASS | T1-T15, T20-T38, and T40-T52 |
