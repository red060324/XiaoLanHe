...
|---|---|---|
| Latest local full command | T61 `XLH_TEST_DATABASE_URL=<isolated PostgreSQL 17 database URL> make ci BASE_REF=origin/master`: Go vet/tests/race against PostgreSQL 17 + pgvector, 50 frontend tests/build, hooks, architecture and spec drift | PASS |
...
| All product PRE_MERGE behavior | PASS | T1-T15 and T20-T61 pass |
