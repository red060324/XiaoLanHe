...
| Go vet and all tests | local `make ci`; full GitHub Actions `33366575106` at `9ce9aa0` | PASS |
| Go race | local full repository race; GitHub Actions `33366575106` | PASS |
...
| Seed and container | GitHub Actions `33366575106`: repeated seed, health/readiness/catalog/community/deals/SPA | PASS |
...
| All product PRE_MERGE behavior | PASS | T1-T15 and T20-T27 |
| Final documentation and latest code-bearing clean-checkout CI | PASS | GitHub Actions `33366575106` |
