...
| T25 | PRE_MERGE | IN_PROGRESS | Remove Web Search cache/provider surfaces that have no implementation | AC1, AC8 | focused config/adapter/HTTP tests; public CI pending |
