...
| T23 | PRE_MERGE | IN_PROGRESS | Prevent successful empty model streams from producing empty assistant replies | AC8 | failing-then-passing SSE Answer adapter test; public CI pending |
