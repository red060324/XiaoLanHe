...
| T28 | PRE_MERGE | IN_PROGRESS | Replace an empty assistant placeholder when a non-abort chat stream fails | AC8 | failing-then-passing frontend regression + final CI |
