...
| T21 | PRE_MERGE | IN_PROGRESS | Enforce one bounded query contract across HTTP and Research tools | AC7, AC8 | failing-then-passing UseCase/HTTP tests; full gates pending |
