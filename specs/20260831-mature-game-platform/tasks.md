...
| T30 | PRE_MERGE | IN_PROGRESS | Bind authenticated conversations to their owner and reject predictable session keys | AC2, AC7, AC8 | failing-then-passing Presenter/UseCase/HTTP/PostgreSQL regressions + final CI |
