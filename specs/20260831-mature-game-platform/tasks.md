...
| T31 | PRE_MERGE | IN_PROGRESS | Isolate browser conversation history when the authenticated account changes | AC2, AC8 | failing account-switch frontend regression + final CI |
